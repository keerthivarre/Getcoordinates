...
public class DataBaseHandler extends SQLiteOpenHelper {  
    ...
    private static final String DATABASE_NAME = "Store Location";  
    ...
    public void deleteUserData(String label)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        try
        {
            getWritableDatabase().delete(TABLE_NAME, COLUMN_ID + "=" + label,null);
        }
        catch(Exception e)
        {
            e.printStackTrace();
